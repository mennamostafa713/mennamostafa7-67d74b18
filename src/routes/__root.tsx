...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "موسوعة تشريح جسم الإنسان للتمريض باللغة العربية مع رسوم تفاعلية وأسماء الأعضاء بالإنجليزية واختبارات تعليمية." },
      { name: "author", content: "Menna Mostafa" },
      { property: "og:title", content: "موسوعة التشريح للتمريض" },
      { property: "og:description", content: "تعلم تشريح جسم الإنسان للتمريض — رسوم تفاعلية واختبارات." },
